...
var bomb_count = 0; //Счетчик для бомб
...
function init() {
   ...
   wrap.style.width = FIELD_SIZE_X * FIELD_SIZE_Y + 'px'; // Размер поля взависимости от количества строк и столбцов
...
function startGame() {
   ...
   if ((FIELD_SIZE_X * FIELD_SIZE_Y / 6) > bomb_count) {
